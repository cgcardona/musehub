"""Alembic environment configuration for Muse."""
...
from musehub.db import models  # noqa: F401 - Import to register models
from musehub.db import muse_cli_models  # noqa: F401 - Register Muse CLI commit tables (retained for MuseHub)
